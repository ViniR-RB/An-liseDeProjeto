...
namespace prova_AnaliseProjeto.Controllers
{
    public class PagamentoController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("Id,DateTime,Discriminator,Valor")] Pagamento pagamento)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("Id,DateTime,Discriminator,Valor")] Pagamento pagamento)
        {
            if (id != pagamento.Id)
            {
                return NotFound();
